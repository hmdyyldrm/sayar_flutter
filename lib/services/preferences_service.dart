...
class PreferencesService {
  ...
  // Generic get/set helpers for legacy keys
  static Future<List<String>> getZikir(String key) async {
    final p = await _prefs();
    return p.getStringList(key) ?? [];
  }

  static Future<void> saveZikir(String key, List<String> value) async {
    final p = await _prefs();
